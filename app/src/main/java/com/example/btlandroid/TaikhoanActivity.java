    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setOnItemSelectedListener(item -> {
            ...
            if (itemId == R.id.nav_home) {
                startActivity(new Intent(TaikhoanActivity.this, HomeActivity.class));
                overridePendingTransition(0, 0);
                finish();
                return true;
            } else if (itemId == R.id.nav_doanhthu) {
                startActivity(new Intent(TaikhoanActivity.this, ListHoaDonActivity.class));
                overridePendingTransition(0, 0);
                finish();
                return true;
        ...
        if (currentUser != null) {
            ...
            userRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onCancelled(DatabaseError databaseError) {
                    Toast.makeText(TaikhoanActivity.this, "Lỗi khi lấy dữ liệu: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        } else {
